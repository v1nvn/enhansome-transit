# awesome-transit [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,983 | 🐛 59 | 📅 2026-04-02 [![RSS](https://img.shields.io/badge/Subscribe-RSS-blue.svg)](https://github.com/MobilityData/awesome-transit/commits/master.atom) ⭐ 1,718 | 🐛 24 | 📅 2026-04-02
...
Have something to add or change? Open a [pull request](https://github.com/MobilityData/awesome-transit/pulls) ⭐ 1,718 | 🐛 24 | 📅 2026-04-02 or [issue](https://github.com/MobilityData/awesome-transit/issues) ⭐ 1,718 | 🐛 24 | 📅 2026-04-02 at [MobilityData/awesome-transit](https://github.com/MobilityData/awesome-transit) ⭐ 1,718 | 🐛 24 | 📅 2026-04-02.
...
* [GTFS-books](https://github.com/MobilityData/GTFS-books) ⭐ 21 | 🐛 1 | 📅 2023-05-29 - Comprehensive guides to GTFS and GTFS Realtime. These books were written by [Quentin Zervaas](https://github.com/HendX), and have been donated to [MobilityData](https://mobilitydata.org/) and made open access.
...
* [just\_gtfs](https://github.com/mesozoic-drones/just_gtfs) ⭐ 27 | 🐛 2 | 🌐 C++ | 📅 2023-11-10 - C++17 header-only library for reading and writing GTFS (used in [Valhalla](https://github.com/valhalla/valhalla) ⭐ 5,601 | 🐛 884 | 🌐 C++ | 📅 2026-04-10). Main features: fast reading and writing of GTFS feeds, support for [extended GTFS route types](https://developers.google.com/transit/gtfs/reference/extended-route-types), simple working with GTFS Date and Time formats.

##### C\#

* [ESRI public-transit-tools](https://github.com/Esri/public-transit-tools) ⭐ 188 | 🐛 9 | 🌐 Python | 📅 2026-01-28 - Tools for working with public transit data in ArcGIS (license for ArcGIS required).
...
* [OneBusAway GTFS Modules](https://github.com/OneBusAway/onebusaway-gtfs-modules/wiki) ⭐ 144 | 🐛 31 | 🌐 Java | 📅 2026-04-01 - A Java-based library for reading, writing, and transforming public transit data in the GTFS format, including database support.

##### JavaScript

* [Node-GTFS](https://github.com/BlinkTagInc/node-gtfs) ⭐ 494 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-03 - Loads transit data from GTFS files, unzips it and stores it to a SQLite database. Provides some methods to query for agencies, routes, stops and times.
* [gtfs-via-postgres](https://github.com/derhuerst/gtfs-via-postgres) ⭐ 135 | 🐛 29 | 🌐 JavaScript | 📅 2026-02-21 – Yet another tool to process GTFS using PostgreSQL.
...
* [ESRI public-transit-tools](https://github.com/Esri/public-transit-tools) ⭐ 188 | 🐛 9 | 🌐 Python | 📅 2026-01-28 - Tools for working with public transit data in ArcGIS (license for ArcGIS required).
* [partridge](https://github.com/remix/partridge) ⭐ 184 | 🐛 7 | 🌐 Python | 📅 2023-12-03 - A fast, forgiving Python GTFS reader built on pandas DataFrames.
* [gtfsdb](https://github.com/OpenTransitTools/gtfsdb) ⭐ 179 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Python library for converting GTFS files into a relational database.
* [gtfspy](https://github.com/CxAalto/gtfspy) ⭐ 167 | 🐛 21 | 🌐 Python | 📅 2023-05-23 - Public transport network analysis and travel time computations using Python3. Compatible with Postgres/PostGIS, Oracle, MySQL, and SQLite. Used by [gtfspy-webviz](https://github.com/CxAalto/gtfspy-webviz) ⭐ 67 | 🐛 4 | 🌐 JavaScript | 📅 2024-08-27.
* [gtfs\_functions](https://github.com/Bondify/gtfs_functions) ⭐ 137 | 🐛 12 | 🌐 Python | 📅 2025-10-27 - Python package with useful functions to create geo-spatial visualizations from GTFS feeds.
* [GTFS Kit](https://github.com/mrcagney/gtfs_kit) ⭐ 118 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-03-17 - A Python 3.8+ tool kit for analyzing General Transit Feed Specification (GTFS) data. Supersedes GTFSTK.
...
* [Make GTFS](https://github.com/mrcagney/make_gtfs) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2026-04-07 - A Python library to make GTFS feeds from basic route information.
* [transit\_service\_analyst](https://github.com/psrc/transit_service_analyst) ⭐ 13 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-03-20 - A Python library to support transit service analysis.

##### R

* [tidytransit](https://github.com/r-transit/tidytransit) ⭐ 167 | 🐛 4 | 🌐 R | 📅 2026-02-10 - Use tidytransit to map transit stops and routes, calculate travel times and transit frequencies, and validate transit feeds. tidytransit reads the General Transit Feed Specification into tidyverse and simple features data frames.
* [gtfsio](https://github.com/r-transit/gtfsio) ⭐ 19 | 🐛 3 | 🌐 R | 📅 2026-03-30 - Fast and flexible functions to read and write GTFS in R.
* [mobdb](https://github.com/jasonad123/mobdb) ⭐ 9 | 🐛 1 | 🌐 R | 📅 2026-03-05 - R functions to search, discover, and access transit feed data from the [Mobility Database](https://mobilitydatabase.org/).
* [r-transit](https://github.com/r-transit) - Collection of tools for GTFS in R.

##### Ruby

* [GTFS-viz](https://github.com/vasile/GTFS-viz) ⭐ 92 | 🐛 8 | 🌐 Ruby | 📅 2016-03-20 - Ruby script that converts a set of GTFS files into a SQLite database + GeoJSONs (needed by the [Transit Map](https://github.com/vasile/transit-map) ⭐ 370 | 🐛 10 | 🌐 JavaScript | 📅 2019-03-12 web application)

##### Rust

* [gtfs-structure](https://github.com/rust-transit/gtfs-structure) ⭐ 73 | 🐛 21 | 🌐 Rust | 📅 2026-03-23 - This crates provides GTFS structures and helpers to read GTFS archives.

#### GTFS Converters

Converters from various static schedule formats to and from GTFS.

* [gtfs-to-geojson](https://github.com/BlinkTagInc/gtfs-to-geojson) ⭐ 154 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-22 - Javascript tool that converts transit data in GTFS shapes and stops into geoJSON. This is useful for creating maps of transit routes.
* [osm2gtfs](https://github.com/grote/osm2gtfs) ⭐ 101 | 🐛 32 | 🌐 Python | 📅 2024-04-04 - Turn OpenStreetMap data and schedule information into GTFS.
...
* [gtfs2gps](https://github.com/ipeaGIT/gtfs2gps) ⭐ 81 | 🐛 11 | 🌐 R | 📅 2025-10-08 - An R package that converts public transportation data in GTFS format to GPS-like records in a `data.table`, where each row represents the timestamp of each vehicle at a given spatial resolution.
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 67 | 🐛 12 | 🌐 Rust | 📅 2026-04-10 - A Rust library to convert to/from the following formats: GTFS, NTFS (for Navitia, see [Software for Creating APIs](#software-for-creating-apis)), TransXChange (UK specification), KV1 (NL specification), NeTEx (EU specification).
...
* [NeTEx-to-GTFS Converter Java](https://github.com/entur/netex-gtfs-converter-java) ⭐ 8 | 🐛 6 | 🌐 Java | 📅 2026-04-10 - Converts NeTEX datasets into GTFS datasets. The input NeTEx datasets are required to follow the Nordic NeTEx Profile.
...
* [gtfs-service-area](https://github.com/cal-itp/gtfs-service-area) ⚠️ Archived - Compute a transit service area from static GTFS. Results are output as single-layer .geojson files. Dockerized version of [gtfs-to-geojson](https://github.com/BlinkTagInc/gtfs-to-geojson) ⭐ 154 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-22.
...
* [onebusaway-gtfs-to-barefoot](https://github.com/OneBusAway/onebusaway-gtfs-to-barefoot) ⭐ 1 | 🐛 1 | 🌐 Java | 📅 2020-02-11 - A Java tool to create a [Barefoot](https://github.com/bmwcarit/barefoot) ⭐ 689 | 🐛 58 | 🌐 Java | 📅 2023-04-14 mapfile from a GTFS file.
...
* [pfaedle](https://github.com/ad-freiburg/pfaedle) ⭐ 269 | 🐛 11 | 🌐 C++ | 📅 2026-03-27 - Precise map-matching for GTFS using OpenStreetMap data
* [static-GTFS-manager](https://github.com/WRI-Cities/static-GTFS-manager) ⭐ 157 | 🐛 64 | 🌐 JavaScript | 📅 2022-06-05 - A (self-hosted) browser-based user interface for creating, editing, exporting static GTFS (see [related post](https://groups.google.com/forum/#!topic/transit-developers/GFz5rTJTB0I)).
* [IBI Data Tools](https://github.com/ibi-group/datatools-ui) ⭐ 144 | 🐛 144 | 🌐 JavaScript | 📅 2026-04-08 - A web application that handles GTFS editing, validating, quality checking, and deploying to OpenTripPlanner. (Combines and builds upon the functionality of the deprecated
* [GTFS Editor](https://github.com/conveyal/gtfs-editor) ⭐ 139 | 🐛 134 | 🌐 JavaScript | 📅 2017-06-20 - A (self-hosted) web-based GTFS editing framework. (Note: this project has been deprecated in favor of [IBI Data Tools](https://github.com/ibi-group/datatools-ui) ⭐ 144 | 🐛 144 | 🌐 JavaScript | 📅 2026-04-08.)
* [Data-Tools Server](https://github.com/ibi-group/datatools-server) ⭐ 55 | 🐛 43 | 🌐 Java | 📅 2026-03-30 - Server for IBI's GTFS data management platform.
...
* [bus-router](https://github.com/atlregional/bus-router) ⭐ 40 | 🐛 3 | 🌐 Python | 📅 2016-12-20 - Python script that generates missing shapes.txt for GTFS using routing from [Google Maps Directions API](https://developers.google.com/maps/documentation/directions/) or [OSRM](https://github.com/Project-OSRM/osrm-backend/wiki/Server-api) ⭐ 7,624 | 🐛 372 | 🌐 C++ | 📅 2026-04-11.
* [Gtfs Data Manager](https://github.com/conveyal/gtfs-data-manager) ⭐ 24 | 🐛 37 | 🌐 JavaScript | 📅 2016-04-22 and [GTFS Editor](https://github.com/conveyal/gtfs-editor) ⭐ 139 | 🐛 134 | 🌐 JavaScript | 📅 2017-06-20.)
...
* [Amarillo](https://github.com/mfdz/amarillo) ⭐ 11 | 🐛 11 | 🌐 Python | 📅 2026-03-22 - Aggregates and enhances carpooling-offers and publishes them as GTFS(-RT)
* [gtfs-blocks-to-transfers](https://github.com/TransitApp/GTFS-blocks-to-transfers) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-04-02 - A Python tool to convert GTFS blocks, defined by setting [trip.block\_id](https://github.com/google/transit/blob/master/gtfs/spec/en/reference.md#example-blocks-and-service-day) ⭐ 936 | 🐛 139 | 📅 2026-03-05 into a series of [trip-to-trip transfers (proposal)](https://github.com/google/transit/pull/303) ⭐ 936 | 🐛 139 | 📅 2026-03-05.
...
* [Uttu](https://github.com/entur/uttu) ⭐ 7 | 🐛 19 | 🌐 Java | 📅 2026-04-10 - Back-end for Nplan, a simple timetable editor.
...
* [GTFS Kit](https://github.com/mrcagney/gtfs_kit) ⭐ 118 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-03-17 - A Python 3.8+ tool kit for analyzing and merging General Transit Feed Specification (GTFS) data. [Info on how to aggregate and clean feeds provided here](https://mrcagney.github.io/gtfs_kit_docs/index.html#module-gtfs_kit.cleaners).
* [combine\_gtfs\_feeds](https://github.com/psrc/combine_gtfs_feeds) ⭐ 9 | 🐛 2 | 🌐 Python | 📅 2026-03-20 - A Python tool to combine multiple gtfs feeds into one feed/dataset.
* [gtfsmerge](https://github.com/now8-org/gtfsmerge) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2024-01-30 - A Python Script to merge GTFS ZIP archives into one.

#### GTFS Analysis Tools

* [R5: Rapid Realistic Routing on Real-world and Reimagined networks](https://github.com/conveyal/r5) ⭐ 375 | 🐛 238 | 🌐 Java | 📅 2026-03-24 - A Java-based routing engine developed by Conveyal for multimodal (transit/bike/walk/car) networks. It currently plans many trips over a time window for scenario planning and analytics purposes. A related R wrapper package ([r5r](https://github.com/ipeaGIT/r5r/) ⭐ 230 | 🐛 39 | 🌐 R | 📅 2026-03-28) is developed independently by IPEA. See also the performance comparison from Higgins et al. (2022), linked below.
...
* [ESRI ArcGIS Public Transit Tools (GTFS)](https://github.com/Esri/public-transit-tools) ⭐ 188 | 🐛 9 | 🌐 Python | 📅 2026-01-28 - Tools for working with public transit data in ArcGIS
* [tidytransit](https://github.com/r-transit/tidytransit) ⭐ 167 | 🐛 4 | 🌐 R | 📅 2026-02-10 - An R package to read GTFS data into tibbles and simple features dataframes to map transit stops and routes, calculate travel times and transit frequencies, and validate transit feeds.
* [GTFS Kit](https://github.com/mrcagney/gtfs_kit) ⭐ 118 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-03-17 - A Python 3.6+ tool kit for analyzing General Transit Feed Specification (GTFS) data. Supersedes [GTFSTK](https://github.com/araichev/gtfstk).
* [gtfstools](https://github.com/ipeaGIT/gtfstools) ⭐ 47 | 🐛 19 | 🌐 R | 📅 2025-01-21 - A set of convenient tools for editing and analysing transit feeds in GTFS format in R.
* [GTFS-to-Chart](https://github.com/BlinkTagInc/gtfs-to-chart) ⭐ 39 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-23 - Creates stringline charts showing all vehicles on a transit route from GTFS data.
...
* [Timetable Kit](https://github.com/neroden/timetable_kit) ⭐ 51 | 🐛 5 | 🌐 Python | 📅 2024-08-10 - An open source Python 3.10 module and scripts depending on [GTFS Kit](https://github.com/mrcagney/gtfs_kit) ⭐ 118 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-03-17, designed to create complex printed/PDF timetables with flexible layouts. Currently only working out of the box for Amtrak's GTFS, but under active development.
...
* [MobilityData's gtfs-validator](https://github.com/MobilityData/gtfs-validator) ⭐ 399 | 🐛 150 | 🌐 Java | 📅 2026-04-09 - A open-source GTFS validator canonically following the GTFS spec implemented in Java licensed under Apache v2.0 maintained by [MobilityData](https://mobilitydata.org/).
* [gtfstidy](https://github.com/patrickbr/gtfstidy) ⭐ 144 | 🐛 15 | 🌐 Go | 📅 2026-03-19 - A Go-based tool to tidy and validate GTFS feeds.
* [Conveyal's gtfs-lib](https://github.com/conveyal/gtfs-lib/) ⭐ 80 | 🐛 65 | 🌐 Java | 📅 2024-05-16 - Conveyal's successor to their own [gtfs-validator](https://github.com/conveyal/gtfs-validator) ⭐ 38 | 🐛 19 | 🌐 Java | 📅 2021-04-11, a Java-based library for loading and saving GTFS feeds of arbitrary size with disk-backed storage.
...
* [Transport Validator](https://github.com/etalab/transport-validator/) ⭐ 46 | 🐛 12 | 🌐 Rust | 📅 2026-04-02 - An open-source validator implemented in [Rust](https://www.rust-lang.org/). Used by the [French National Access Point](https://transport.data.gouv.fr/validation/).
* [Conveyal's gtfs-validator](https://github.com/conveyal/gtfs-validator) ⭐ 38 | 🐛 19 | 🌐 Java | 📅 2021-04-11 - A Java-based GTFS validator based on the OneBusAway GTFS Modules, runs in Java and is faster than the Google provided one.
...
* [gtfsclean](https://github.com/public-transport/gtfsclean) ⭐ 17 | 🐛 4 | 🌐 Go | 📅 2025-09-13 - A tool for checking, sanitizing, and minimizing GTFS feeds. Fork of gtfstidy, with some additional fixes that haven't been merged upstream yet.
...
* [gtfs-validator-api](https://github.com/cal-itp/gtfs-validator-api) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2023-08-16 - This Python package is a thin wrapper around [MobilityData/gtfs-validator](https://github.com/MobilityData/gtfs-validator) ⭐ 399 | 🐛 150 | 🌐 Java | 📅 2026-04-09 that handles intermediate files produced and finds gtfs-validator's output file so it can be given a specific name or returned as a string.
* [gtfs-accessiblity-validator](https://github.com/BlinkTagInc/gtfs-accessibility-validator) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-04 - Validates the presence of accessiblity-related fields and files in a GTFS file. Can be a command line tool or node.js package.

### GTFS Realtime

* [GTFS-realtime documentation](https://github.com/google/transit/tree/master/gtfs-realtime) ⭐ 936 | 🐛 139 | 📅 2026-03-05.
* [GTFS-realtime Autodoc](https://laidig.github.io/gtfs-rt-autodoc/index.html) - Automatically generated documentation for GTFS-realtime, generated from the official [GTFS-realtime protocol buffer specification](https://github.com/google/transit/blob/master/gtfs-realtime/proto/gtfs-realtime.proto) ⭐ 936 | 🐛 139 | 📅 2026-03-05 and including some extensions.

#### GTFS Realtime Libraries & Demo Apps

* [gtfs-realtime-bindings](https://github.com/google/gtfs-realtime-bindings) ⭐ 421 | 🐛 39 | 🌐 JavaScript | 📅 2026-03-23 - The official bindings for Java, .NET, Node.js, Python, and Ruby generated from the official [GTFS-realtime protocol buffer specification](https://github.com/google/transit/blob/master/gtfs-realtime/proto/gtfs-realtime.proto) ⭐ 936 | 🐛 139 | 📅 2026-03-05.
* [GTFS-realtime Vehicle Positions Consumer/Visualizer Demo](https://github.com/OneBusAway/onebusaway-gtfs-realtime-visualizer) ⭐ 66 | 🐛 6 | 🌐 Java | 📅 2022-09-07 - A Java-based demo project for consuming a GTFS-realtime Vehicle Positions feed and displaying this info on a map.
...
* [gtfs-realtime-validator](https://github.com/MobilityData/gtfs-realtime-validator) ⭐ 56 | 🐛 130 | 🌐 Java | 📅 2026-03-18 - A GTFS Realtime validation tool originally developed by the [Center for Urban Transportation Research](https://www.cutr.usf.edu/) at the University of South Florida and now maintained by [MobilityData](https://mobilitydata.org/).
...
* [gtfs-realtime-translators](https://github.com/Intersection/gtfs-realtime-translators) ⭐ 21 | 🐛 2 | 🌐 Python | 📅 2026-02-24 - A Python-based tool to translate custom arrival API formats to GTFS-realtime.  As of July 2019 it supports LA Metro and SEPTA.
...
* [Transloc API to GTFS-realtime](https://github.com/jonathonwpowell/transloc-to-gtfs-real-time) ⭐ 3 | 🐛 22 | 🌐 JavaScript | 📅 2023-01-05 - A Node.js based tool to convert the Transloc API to GTFS-realtime.
...
* [gtfs-rt-inspector](https://public-transport.github.io/gtfs-rt-inspector/) – Web app to inspect & analyze any (CORS-enabled) GTFS Realtime feed. Open-source on [GitHub](https://github.com/public-transport/gtfs-rt-inspector) ⭐ 55 | 🐛 11 | 🌐 JavaScript | 📅 2026-02-26.
...
* [Concentrate](https://github.com/mbta/concentrate) ⭐ 30 | 🐛 15 | 🌐 Elixir | 📅 2026-04-11 - Combines realtime transit information from multiple sources into single output files. Maintained by [
...
* [SIRI API](https://github.com/OneBusAway/onebusaway/wiki/SIRI-Resources) ⭐ 363 | 🐛 10 | 📅 2024-06-05 - Java classes generated from the v1.0 and v1.3 [SIRI](https://www.siri.org.uk/) schemas.
...
* [Edwig](https://github.com/af83/edwig) ⭐ 21 | 🐛 1 | 🌐 Go | 📅 2025-12-17 - A golang server for real-time public transport data exchange, using the SIRI protocol.
...
* [MDS](https://github.com/openmobilityfoundation/mobility-data-specification) ⭐ 731 | 🐛 24 | 📅 2026-04-09 - Mobility Data Specification: A format to implement realtime data sharing, measurement and regulation for municipalities and mobility as a service providers. It is meant to ensure that governments have the ability to enforce, evaluate and manage providers. Maintained by the [Open Mobility Foundation](https://www.openmobilityfoundation.org/).
* [TOMP](https://github.com/TOMP-WG/TOMP-API) ⭐ 108 | 🐛 47 | 🌐 Python | 📅 2026-02-18 - Transport Operator Mobility-as-a-service Provider API: API standard for use by transport operators and mobility-as-a-service providers for operator discovery, trip planning, end user interaction, booking, and payment.
...
* [GMNS](https://github.com/zephyr-data-specs/GMNS) ⭐ 128 | 🐛 24 | 🌐 Jupyter Notebook | 📅 2026-04-02 - General Modeling Network Specification: A format for sharing routable road network files designed to be used in multi-modal static and dynamic transportation planning and operations models. Volpe/FHWA partnership with Zephyr Foundation.
* [OSDM](https://github.com/UnionInternationalCheminsdeFer/OSDM) ⭐ 85 | 🐛 45 | 🌐 Shell | 📅 2026-04-04 - Open Sales and Distribution Model: Aims to substantially simplify the booking process for customers of rail trips and to lower complexity and distribution costs for distributors and railway carriers. Contains a specification of an offline model and on-line API. Maintained by the [International Union of Railways (UIC)](https://github.com/UnionInternationalCheminsdeFer).
* [CurbLR](https://github.com/curblr/curblr-spec) ⭐ 74 | 🐛 3 | 🌐 JavaScript | 📅 2024-07-16 - A specification for curb regulations.
* [OMX: The Open Matrix data file format](https://github.com/osPlanning/omx) ⭐ 55 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2025-12-16 - A structured collection of two-dimensional array objects and associated metadata, for possible use in the transportation modeling industry.
* [TIDES](https://github.com/TIDES-transit/TIDES) ⭐ 54 | 🐛 50 | 🌐 Python | 📅 2026-03-12 -  Transit ITS Data Exchange Specification (TIDES) is a proposed effort to create standard data structures, APIs, and data management tools for historical transit ITS data including AVL, APC and AFC Data.
...
* [OJP](https://github.com/VDVde/OJP) ⭐ 36 | 🐛 34 | 🌐 XSLT | 📅 2025-08-27 - Open Journey Planner.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper/#public-transit) ⭐ 6,400 | 🐛 248 | 🌐 Java | 📅 2026-04-10 Open source routing engine for OpenStreetMap. Use it as Java library or server.
* [pyBikes](https://github.com/eskerda/pybikes) ⭐ 600 | 🐛 31 | 🌐 Python | 📅 2026-04-10 - Software powering [CityBikes](http://api.citybik.es) for worldwide bikeshare system info
* [MOTIS](https://github.com/motis-project/motis) ⭐ 491 | 🐛 91 | 🌐 C++ | 📅 2026-04-09 - Multi Objective Travel Information System, written in C++ and Java. Can consume schedule timetables in the GTFS or HAFAS format as well as real time information in the GTFS-RT (and RISML, a propriatary format at Deutsche Bahn) as input data. For pedestrian routing (handled by Per Pedes Routing) and car routing (handled by OSRM) OpenStreetMap data is used.
* [Navitia](https://github.com/hove-io/navitia) ⭐ 452 | 🐛 44 | 🌐 Python | 📅 2026-04-07 is the opensource engine behind the [Navitia.io](http://www.navitia.io/) live API.
* [OneBusAway](http://onebusaway.org/) - A Java app that consumes GTFS and GTFS-Realtime (along with [other formats](https://github.com/OneBusAway/onebusaway-application-modules/wiki/Real-Time-Data-Configuration-Guide) ⭐ 236 | 🐛 79 | 🌐 Java | 📅 2026-02-08) and turns them into an easy to use REST API.
...
* [The Mobility Database](https://mobilitydatabase.org/) - JSON and CSV files [on GitHub](https://github.com/MobilityData/mobility-database-catalogs) ⭐ 327 | 🐛 196 | 🌐 Python | 📅 2026-04-10 that is a repository of 2000+ mobility datasets across the world. Contains contents of OpenMobilityData/TransitFeeds.com.
...
* [CityBikes](http://api.citybik.es) - REST API for aggregated bikeshare data from around the world. Powered by [pyBikes](https://github.com/eskerda/pybikes) ⭐ 600 | 🐛 31 | 🌐 Python | 📅 2026-04-10.
* [Navitia.io](http://www.navitia.io/) - REST API for journey planning, stop schedules, isochrones and lot more on US and EU. [Navitia](https://github.com/hove-io/navitia) ⭐ 452 | 🐛 44 | 🌐 Python | 📅 2026-04-07 is the opensource engine behind the live API.
...
* [GTFS-Hub](https://github.com/mfdz/gtfs-hub) ⭐ 33 | 🐛 8 | 🌐 Makefile | 📅 2026-03-23 - Community tested, probably quality/content enhanced, partially merged or filtered GTFS-feeds of (currently German) transport agencies. Maintained by [MITFAHR|DE|ZENTRALE](https://github.com/mfdz).

#### Sample GTFS and GTFS Realtime datasets used for software testing

* [OpenTripPlanner unit tests](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test) ⭐ 2,604 | 🐛 167 | 🌐 Java | 📅 2026-04-11 - Some [GTFS datasets](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test/resources/gtfs) ⭐ 2,604 | 🐛 167 | 🌐 Java | 📅 2026-04-11 are defined for the unit tests ([GtfsTest](https://github.com/opentripplanner/OpenTripPlanner/blob/dev-2.x/src/test/java/org/opentripplanner/GtfsTest.java) ⭐ 2,604 | 🐛 167 | 🌐 Java | 📅 2026-04-11 and [mmri folder](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test/java/org/opentripplanner/mmri) ⭐ 2,604 | 🐛 167 | 🌐 Java | 📅 2026-04-11).
...
* [gtfs-realtime-validator unit tests](https://github.com/MobilityData/gtfs-realtime-validator/tree/master/gtfs-realtime-validator-lib/src/test/) ⭐ 56 | 🐛 130 | 🌐 Java | 📅 2026-03-18 - Some [GTFS datasets (zip files)](https://github.com/MobilityData/gtfs-realtime-validator/tree/master/gtfs-realtime-validator-lib/src/test/resources) ⭐ 56 | 🐛 130 | 🌐 Java | 📅 2026-03-18 are included and a large number of GTFS RT messages are defined [programmatically in Java](https://github.com/MobilityData/gtfs-realtime-validator/tree/master/gtfs-realtime-validator-lib/src/test/java/edu/usf/cutr/gtfsrtvalidator/lib/test/rules) ⭐ 56 | 🐛 130 | 🌐 Java | 📅 2026-03-18 via the gtfs-realtime-bindings library.
* [Transitland GTFS and GTFS Realtime unit tests](https://github.com/interline-io/transitland-lib) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-09 - For testing the [transitland-lib](https://github.com/interline-io/transitland-lib) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-09 library that handles GTFS and GTFS Realtime parsing and validation for Transitland:
  * [GTFS - "bad entities" at the single row level](https://github.com/interline-io/transitland-lib/tree/master/test/data/bad-entities) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-09
  * [GTFS - validation errors that that involve entities in one or more files](https://github.com/interline-io/transitland-lib/tree/master/test/data/validator/errors) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-09
  * [GTFS - best practices](https://github.com/interline-io/transitland-lib/tree/master/test/data/validator/best-practices) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-09
...
* [Transitive.js](https://github.com/conveyal/transitive.js) ⭐ 697 | 🐛 21 | 🌐 JavaScript | 📅 2026-04-07 - Creates a customizable web map layer of transit routes using Leaflet or D3.
...
* [Transit-Map](https://github.com/vasile/transit-map) ⭐ 370 | 🐛 10 | 🌐 JavaScript | 📅 2019-03-12 - Web app that animates vehicles (markers) on a map using the public transport timetables to interpolate their positions along the routes (polylines).
* [Bustime](https://busti.me) - Public transport real-time monitoring with WebSocket updates. Open-source [on GitHub](https://github.com/norn/bustime) ⭐ 97 | 🐛 0 | 🌐 JavaScript | 📅 2024-11-22.
* [OTP-UI React Component Library](https://github.com/opentripplanner/otp-ui) ⭐ 71 | 🐛 84 | 🌐 TypeScript | 📅 2026-04-10 - React Javascript component library, which can be used to build trip planner webapps. See the [Storybook](http://www.opentripplanner.org/otp-ui) for a demo.
...
* [MBTA tile-server](https://github.com/mbta/tile-server) ⭐ 9 | 🐛 0 | 🌐 CartoCSS | 📅 2026-03-06 - Scripts to create a Docker container that encapsulates all the elements necessary to develop map tiles for use on MBTA.com
...
* [Transportr](https://github.com/grote/Transportr) ⭐ 1,158 | 🐛 112 | 🌐 Kotlin | 📅 2026-03-24 An Android app that uses [public-transport-enabler](https://github.com/schildbach/public-transport-enabler) ⭐ 436 | 🐛 198 | 🌐 Java | 📅 2026-03-24 in order to connect to many different transport networks worldwide.
* OneBusAway Apps - [Android](https://play.google.com/store/apps/details?id=com.joulespersecond.seattlebusbot) [*(source code)*](https://github.com/OneBusAway/onebusaway-android) ⭐ 542 | 🐛 188 | 🌐 Java | 📅 2026-03-20, [Fire Phone](http://www.amazon.com/gp/mas/dl/android?p=com.joulespersecond.seattlebusbot) [*(source code)*](https://github.com/OneBusAway/onebusaway-android) ⭐ 542 | 🐛 188 | 🌐 Java | 📅 2026-03-20, [iOS](https://itunes.apple.com/us/app/onebusaway/id329380089)  [*(source code)*](https://github.com/OneBusAway/onebusaway-ios) ⭐ 142 | 🐛 101 | 🌐 Swift | 📅 2026-04-10, [Windows Phone](https://www.microsoft.com/en-us/store/apps/onebusaway/9nblggh0cbd9) [*(source code)*](https://github.com/OneBusAway/onebusaway-windows-phone) ⚠️ Archived, [Google Glass GDK](https://github.com/OneBusAway/onebusaway-android/pull/219) ⭐ 542 | 🐛 188 | 🌐 Java | 📅 2026-03-20 [*(source code)*](https://github.com/OneBusAway/onebusaway-android/pull/219) ⭐ 542 | 🐛 188 | 🌐 Java | 📅 2026-03-20, [Alexa skill](https://www.amazon.com/OneBusAway/dp/B01ELVUYCW/) [*(source code)*](https://github.com/OneBusAway/onebusaway-alexa) ⭐ 52 | 🐛 17 | 🌐 Java | 📅 2022-12-16
...
* [Train departure Display](https://github.com/chrisys/train-departure-display) ⭐ 314 | 🐛 30 | 🌐 Python | 📅 2026-02-19 - A replica, near real-time, miniature UK railway station train departure sign based upon a Raspberry Pi Zer0.
...
* [TripKit](https://github.com/alexander-albers/tripkit) ⭐ 110 | 🐛 11 | 🌐 Swift | 📅 2026-03-31 - TripKit is a Swift-library to get data from public transport providers.
...
* [Mapnificent](https://www.mapnificent.net/) - Shows areas you can reach with public transport in a given time. Open-source [on GitHub](https://github.com/mapnificent/mapnificent) ⭐ 399 | 🐛 22 | 🌐 JavaScript | 📅 2024-04-19, live at <https://www.mapnificent.net/>.
* [TransitFlow](https://github.com/transitland/transitland-processing-animation) ⭐ 290 | 🐛 6 | 🌐 Processing | 📅 2020-01-22 Animate GTFS data around the world using Processing and Transitland.
* [gtfs-visualizations](https://github.com/cmichi/gtfs-visualizations) ⭐ 141 | 🐛 1 | 🌐 JavaScript | 📅 2020-12-31 - Open-source NodeJS application for visualizing the routes of GTFS datasets.
* [gtfspy-webviz](https://github.com/CxAalto/gtfspy-webviz) ⭐ 67 | 🐛 4 | 🌐 JavaScript | 📅 2024-08-27 - Web application for animation and visualization of GTFS data using [gtfspy](https://github.com/CxAalto/gtfspy) ⭐ 167 | 🐛 21 | 🌐 Python | 📅 2023-05-23.
* [GTFS Viz 🚉](https://github.com/gabrielAHN/gtfs-viz) ⭐ 44 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-08 - A web app that visualizes GTFS Data on the browser at scale without a backend on the client side using [duckdb-wasm 🦆](https://duckdb.org/docs/api/wasm/overview.html).
* [Toronto Transit Explorer](https://github.com/sidewalklabs/totx) ⚠️ Archived - A Java application that visualizes transit, biking and walking accessibility across the city of Toronto. Uses a modified version of [R5](https://github.com/conveyal/r5) ⭐ 375 | 🐛 238 | 🌐 Java | 📅 2026-03-24 for routing.
...
* [loom](https://github.com/ad-freiburg/loom) ⭐ 256 | 🐛 12 | 🌐 C++ | 📅 2026-04-01 - Software suite for the automated generation of geographically correct or schematic transit maps.
...
* [Next Train API](https://github.com/data-creative/next-train-api) ⭐ 5 | 🐛 1 | 🌐 Ruby | 📅 2018-12-29 - Serves any GTFS feed as a JSON API. Transit agencies and developers alike can deploy the open source code to their own Heroku server.
...
* [OpenTripPlanner](https://github.com/opentripplanner/OpenTripPlanner) ⭐ 2,604 | 🐛 167 | 🌐 Java | 📅 2026-04-11 Community
