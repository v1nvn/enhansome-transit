...
* [gtfspy](https://github.com/CxAalto/gtfspy) ⭐ 168 | 🐛 21 | 🌐 Python | 📅 2023-05-23 - Public transport network analysis and travel time computations using Python3. Compatible with Postgres/PostGIS, Oracle, MySQL, and SQLite. Used by [gtfspy-webviz](https://github.com/CxAalto/gtfspy-webviz) ⭐ 66 | 🐛 4 | 🌐 JavaScript | 📅 2024-08-27.
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 67 | 🐛 12 | 🌐 Rust | 📅 2026-04-07 - A Rust library to convert to/from the following formats: GTFS, NTFS (for Navitia, see [Software for Creating APIs](#software-for-creating-apis)), TransXChange (UK specification), KV1 (NL specification), NeTEx (EU specification).
...
* [bus-router](https://github.com/atlregional/bus-router) ⭐ 40 | 🐛 3 | 🌐 Python | 📅 2016-12-20 - Python script that generates missing shapes.txt for GTFS using routing from [Google Maps Directions API](https://developers.google.com/maps/documentation/directions/) or [OSRM](https://github.com/Project-OSRM/osrm-backend/wiki/Server-api) ⭐ 7,617 | 🐛 374 | 🌐 C++ | 📅 2026-04-07.
...
* [Uttu](https://github.com/entur/uttu) ⭐ 7 | 🐛 19 | 🌐 Java | 📅 2026-04-07 - Back-end for Nplan, a simple timetable editor.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper/#public-transit) ⭐ 6,398 | 🐛 250 | 🌐 Java | 📅 2026-04-07 Open source routing engine for OpenStreetMap. Use it as Java library or server.
* [pyBikes](https://github.com/eskerda/pybikes) ⭐ 599 | 🐛 31 | 🌐 Python | 📅 2026-04-07 - Software powering [CityBikes](http://api.citybik.es) for worldwide bikeshare system info
...
* [The Mobility Database](https://mobilitydatabase.org/) - JSON and CSV files [on GitHub](https://github.com/MobilityData/mobility-database-catalogs) ⭐ 327 | 🐛 194 | 🌐 Python | 📅 2026-03-27 that is a repository of 2000+ mobility datasets across the world. Contains contents of OpenMobilityData/TransitFeeds.com.
...
* [CityBikes](http://api.citybik.es) - REST API for aggregated bikeshare data from around the world. Powered by [pyBikes](https://github.com/eskerda/pybikes) ⭐ 599 | 🐛 31 | 🌐 Python | 📅 2026-04-07.
...
* [OpenTripPlanner unit tests](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test) ⭐ 2,599 | 🐛 157 | 🌐 Java | 📅 2026-04-07 - Some [GTFS datasets](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test/resources/gtfs) ⭐ 2,599 | 🐛 157 | 🌐 Java | 📅 2026-04-07 are defined for the unit tests ([GtfsTest](https://github.com/opentripplanner/OpenTripPlanner/blob/dev-2.x/src/test/java/org/opentripplanner/GtfsTest.java) ⭐ 2,599 | 🐛 157 | 🌐 Java | 📅 2026-04-07 and [mmri folder](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test/java/org/opentripplanner/mmri) ⭐ 2,599 | 🐛 157 | 🌐 Java | 📅 2026-04-07).
...
* [Transitland GTFS and GTFS Realtime unit tests](https://github.com/interline-io/transitland-lib) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-08 - For testing the [transitland-lib](https://github.com/interline-io/transitland-lib) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-08 library that handles GTFS and GTFS Realtime parsing and validation for Transitland:
  * [GTFS - "bad entities" at the single row level](https://github.com/interline-io/transitland-lib/tree/master/test/data/bad-entities) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-08
  * [GTFS - validation errors that that involve entities in one or more files](https://github.com/interline-io/transitland-lib/tree/master/test/data/validator/errors) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-08
  * [GTFS - best practices](https://github.com/interline-io/transitland-lib/tree/master/test/data/validator/best-practices) ⭐ 50 | 🐛 27 | 🌐 Go | 📅 2026-04-08
...
* [Transportr](https://github.com/grote/Transportr) ⭐ 1,157 | 🐛 112 | 🌐 Kotlin | 📅 2026-03-24 An Android app that uses [public-transport-enabler](https://github.com/schildbach/public-transport-enabler) ⭐ 436 | 🐛 198 | 🌐 Java | 📅 2026-03-24 in order to connect to many different transport networks worldwide.
...
* [gtfspy-webviz](https://github.com/CxAalto/gtfspy-webviz) ⭐ 66 | 🐛 4 | 🌐 JavaScript | 📅 2024-08-27 - Web application for animation and visualization of GTFS data using [gtfspy](https://github.com/CxAalto/gtfspy) ⭐ 168 | 🐛 21 | 🌐 Python | 📅 2023-05-23.
...
* [OpenTripPlanner](https://github.com/opentripplanner/OpenTripPlanner) ⭐ 2,599 | 🐛 157 | 🌐 Java | 📅 2026-04-07 Community
