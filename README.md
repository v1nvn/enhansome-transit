...
* [NeTEx-to-GTFS Converter Java](https://github.com/entur/netex-gtfs-converter-java) ⭐ 8 | 🐛 10 | 🌐 Java | 📅 2026-03-09 - Converts NeTEX datasets into GTFS datasets. The input NeTEx datasets are required to follow the Nordic NeTEx Profile.
...
* [pfaedle](https://github.com/ad-freiburg/pfaedle) ⭐ 266 | 🐛 11 | 🌐 C++ | 📅 2026-01-09 - Precise map-matching for GTFS using OpenStreetMap data
...
* [IBI Data Tools](https://github.com/ibi-group/datatools-ui) ⭐ 142 | 🐛 150 | 🌐 JavaScript | 📅 2026-03-12 - A web application that handles GTFS editing, validating, quality checking, and deploying to OpenTripPlanner. (Combines and builds upon the functionality of the deprecated
* [GTFS Editor](https://github.com/conveyal/gtfs-editor) ⭐ 141 | 🐛 134 | 🌐 JavaScript | 📅 2017-06-20 - A (self-hosted) web-based GTFS editing framework. (Note: this project has been deprecated in favor of [IBI Data Tools](https://github.com/ibi-group/datatools-ui) ⭐ 142 | 🐛 150 | 🌐 JavaScript | 📅 2026-03-12.)
...
* [bus-router](https://github.com/atlregional/bus-router) ⭐ 40 | 🐛 3 | 🌐 Python | 📅 2016-12-20 - Python script that generates missing shapes.txt for GTFS using routing from [Google Maps Directions API](https://developers.google.com/maps/documentation/directions/) or [OSRM](https://github.com/Project-OSRM/osrm-backend/wiki/Server-api) ⭐ 7,556 | 🐛 418 | 🌐 C++ | 📅 2026-03-13.
...
* [Uttu](https://github.com/entur/uttu) ⭐ 7 | 🐛 15 | 🌐 Java | 📅 2026-03-09 - Back-end for Nplan, a simple timetable editor.
...
* [gtfs-realtime-bindings](https://github.com/google/gtfs-realtime-bindings) ⭐ 418 | 🐛 34 | 🌐 Java | 📅 2026-03-11 - The official bindings for Java, .NET, Node.js, Python, and Ruby generated from the official [GTFS-realtime protocol buffer specification](https://github.com/google/transit/blob/master/gtfs-realtime/proto/gtfs-realtime.proto) ⭐ 920 | 🐛 135 | 📅 2026-03-05.
* [GTFS-realtime Vehicle Positions Consumer/Visualizer Demo](https://github.com/OneBusAway/onebusaway-gtfs-realtime-visualizer) ⭐ 65 | 🐛 6 | 🌐 Java | 📅 2022-09-07 - A Java-based demo project for consuming a GTFS-realtime Vehicle Positions feed and displaying this info on a map.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper/#public-transit) ⭐ 6,321 | 🐛 256 | 🌐 Java | 📅 2026-03-14 Open source routing engine for OpenStreetMap. Use it as Java library or server.
...
* [GTFS-Hub](https://github.com/mfdz/gtfs-hub) ⭐ 32 | 🐛 8 | 🌐 Makefile | 📅 2026-01-31 - Community tested, probably quality/content enhanced, partially merged or filtered GTFS-feeds of (currently German) transport agencies. Maintained by [MITFAHR|DE|ZENTRALE](https://github.com/mfdz).

#### Sample GTFS and GTFS Realtime datasets used for software testing

* [OpenTripPlanner unit tests](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test) ⭐ 2,570 | 🐛 154 | 🌐 Java | 📅 2026-03-15 - Some [GTFS datasets](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test/resources/gtfs) ⭐ 2,570 | 🐛 154 | 🌐 Java | 📅 2026-03-15 are defined for the unit tests ([GtfsTest](https://github.com/opentripplanner/OpenTripPlanner/blob/dev-2.x/src/test/java/org/opentripplanner/GtfsTest.java) ⭐ 2,570 | 🐛 154 | 🌐 Java | 📅 2026-03-15 and [mmri folder](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test/java/org/opentripplanner/mmri) ⭐ 2,570 | 🐛 154 | 🌐 Java | 📅 2026-03-15).
...
* [Transportr](https://github.com/grote/Transportr) ⭐ 1,152 | 🐛 109 | 🌐 Kotlin | 📅 2025-12-03 An Android app that uses [public-transport-enabler](https://github.com/schildbach/public-transport-enabler) ⭐ 434 | 🐛 194 | 🌐 Java | 📅 2026-03-06 in order to connect to many different transport networks worldwide.
* OneBusAway Apps - [Android](https://play.google.com/store/apps/details?id=com.joulespersecond.seattlebusbot) [*(source code)*](https://github.com/OneBusAway/onebusaway-android) ⭐ 538 | 🐛 172 | 🌐 Java | 📅 2026-03-15, [Fire Phone](http://www.amazon.com/gp/mas/dl/android?p=com.joulespersecond.seattlebusbot) [*(source code)*](https://github.com/OneBusAway/onebusaway-android) ⭐ 538 | 🐛 172 | 🌐 Java | 📅 2026-03-15, [iOS](https://itunes.apple.com/us/app/onebusaway/id329380089)  [*(source code)*](https://github.com/OneBusAway/onebusaway-ios) ⭐ 141 | 🐛 93 | 🌐 Swift | 📅 2026-03-13, [Windows Phone](https://www.microsoft.com/en-us/store/apps/onebusaway/9nblggh0cbd9) [*(source code)*](https://github.com/OneBusAway/onebusaway-windows-phone) ⚠️ Archived, [Google Glass GDK](https://github.com/OneBusAway/onebusaway-android/pull/219) ⭐ 538 | 🐛 172 | 🌐 Java | 📅 2026-03-15 [*(source code)*](https://github.com/OneBusAway/onebusaway-android/pull/219) ⭐ 538 | 🐛 172 | 🌐 Java | 📅 2026-03-15, [Alexa skill](https://www.amazon.com/OneBusAway/dp/B01ELVUYCW/) [*(source code)*](https://github.com/OneBusAway/onebusaway-alexa) ⭐ 52 | 🐛 17 | 🌐 Java | 📅 2022-12-16
...
* [Toronto Transit Explorer](https://github.com/sidewalklabs/totx) ⚠️ Archived - A Java application that visualizes transit, biking and walking accessibility across the city of Toronto. Uses a modified version of [R5](https://github.com/conveyal/r5) ⭐ 369 | 🐛 238 | 🌐 Java | 📅 2026-01-26 for routing.
...
* [loom](https://github.com/ad-freiburg/loom) ⭐ 250 | 🐛 13 | 🌐 C++ | 📅 2026-02-08 - Software suite for the automated generation of geographically correct or schematic transit maps.
...
* [OpenTripPlanner](https://github.com/opentripplanner/OpenTripPlanner) ⭐ 2,570 | 🐛 154 | 🌐 Java | 📅 2026-03-15 Community
