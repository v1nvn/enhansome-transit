# awesome-transit [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 446,124 | 🐛 83 | 📅 2026-03-09 [![RSS](https://img.shields.io/badge/Subscribe-RSS-blue.svg)](https://github.com/MobilityData/awesome-transit/commits/master.atom) ⭐ 1,699 | 🐛 18 | 📅 2026-01-30
...
Have something to add or change? Open a [pull request](https://github.com/MobilityData/awesome-transit/pulls) ⭐ 1,699 | 🐛 18 | 📅 2026-01-30 or [issue](https://github.com/MobilityData/awesome-transit/issues) ⭐ 1,699 | 🐛 18 | 📅 2026-01-30 at [MobilityData/awesome-transit](https://github.com/MobilityData/awesome-transit) ⭐ 1,699 | 🐛 18 | 📅 2026-01-30.
...
* [Node-GTFS](https://github.com/BlinkTagInc/node-gtfs) ⭐ 494 | 🐛 8 | 🌐 TypeScript | 📅 2026-01-22 - Loads transit data from GTFS files, unzips it and stores it to a SQLite database. Provides some methods to query for agencies, routes, stops and times.
...
* [gtfs-structure](https://github.com/rust-transit/gtfs-structure) ⭐ 71 | 🐛 21 | 🌐 Rust | 📅 2026-02-03 - This crates provides GTFS structures and helpers to read GTFS archives.
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 66 | 🐛 11 | 🌐 Rust | 📅 2026-03-12 - A Rust library to convert to/from the following formats: GTFS, NTFS (for Navitia, see [Software for Creating APIs](#software-for-creating-apis)), TransXChange (UK specification), KV1 (NL specification), NeTEx (EU specification).
...
* [pfaedle](https://github.com/ad-freiburg/pfaedle) ⭐ 267 | 🐛 11 | 🌐 C++ | 📅 2026-01-09 - Precise map-matching for GTFS using OpenStreetMap data
...
* [IBI Data Tools](https://github.com/ibi-group/datatools-ui) ⭐ 143 | 🐛 150 | 🌐 JavaScript | 📅 2026-03-16 - A web application that handles GTFS editing, validating, quality checking, and deploying to OpenTripPlanner. (Combines and builds upon the functionality of the deprecated
* [GTFS Editor](https://github.com/conveyal/gtfs-editor) ⭐ 141 | 🐛 134 | 🌐 JavaScript | 📅 2017-06-20 - A (self-hosted) web-based GTFS editing framework. (Note: this project has been deprecated in favor of [IBI Data Tools](https://github.com/ibi-group/datatools-ui) ⭐ 143 | 🐛 150 | 🌐 JavaScript | 📅 2026-03-16.)
* [Data-Tools Server](https://github.com/ibi-group/datatools-server) ⭐ 54 | 🐛 43 | 🌐 Java | 📅 2026-03-09 - Server for IBI's GTFS data management platform.
...
* [bus-router](https://github.com/atlregional/bus-router) ⭐ 40 | 🐛 3 | 🌐 Python | 📅 2016-12-20 - Python script that generates missing shapes.txt for GTFS using routing from [Google Maps Directions API](https://developers.google.com/maps/documentation/directions/) or [OSRM](https://github.com/Project-OSRM/osrm-backend/wiki/Server-api) ⭐ 7,562 | 🐛 418 | 🌐 C++ | 📅 2026-03-13.
...
* [MobilityData's gtfs-validator](https://github.com/MobilityData/gtfs-validator) ⭐ 396 | 🐛 149 | 🌐 Java | 📅 2026-03-13 - A open-source GTFS validator canonically following the GTFS spec implemented in Java licensed under Apache v2.0 maintained by [MobilityData](https://mobilitydata.org/).
* [gtfstidy](https://github.com/patrickbr/gtfstidy) ⭐ 144 | 🐛 15 | 🌐 Go | 📅 2026-01-19 - A Go-based tool to tidy and validate GTFS feeds.
...
* [gtfs-validator-api](https://github.com/cal-itp/gtfs-validator-api) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2023-08-16 - This Python package is a thin wrapper around [MobilityData/gtfs-validator](https://github.com/MobilityData/gtfs-validator) ⭐ 396 | 🐛 149 | 🌐 Java | 📅 2026-03-13 that handles intermediate files produced and finds gtfs-validator's output file so it can be given a specific name or returned as a string.
...
* [gtfs-realtime-bindings](https://github.com/google/gtfs-realtime-bindings) ⭐ 419 | 🐛 34 | 🌐 Java | 📅 2026-03-11 - The official bindings for Java, .NET, Node.js, Python, and Ruby generated from the official [GTFS-realtime protocol buffer specification](https://github.com/google/transit/blob/master/gtfs-realtime/proto/gtfs-realtime.proto) ⭐ 921 | 🐛 135 | 📅 2026-03-05.
...
* [gtfs-realtime-validator](https://github.com/MobilityData/gtfs-realtime-validator) ⭐ 55 | 🐛 128 | 🌐 Java | 📅 2026-03-12 - A GTFS Realtime validation tool originally developed by the [Center for Urban Transportation Research](https://www.cutr.usf.edu/) at the University of South Florida and now maintained by [MobilityData](https://mobilitydata.org/).
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper/#public-transit) ⭐ 6,325 | 🐛 256 | 🌐 Java | 📅 2026-03-16 Open source routing engine for OpenStreetMap. Use it as Java library or server.
* [pyBikes](https://github.com/eskerda/pybikes) ⭐ 599 | 🐛 31 | 🌐 Python | 📅 2026-03-16 - Software powering [CityBikes](http://api.citybik.es) for worldwide bikeshare system info
* [MOTIS](https://github.com/motis-project/motis) ⭐ 474 | 🐛 95 | 🌐 C++ | 📅 2026-03-16 - Multi Objective Travel Information System, written in C++ and Java. Can consume schedule timetables in the GTFS or HAFAS format as well as real time information in the GTFS-RT (and RISML, a propriatary format at Deutsche Bahn) as input data. For pedestrian routing (handled by Per Pedes Routing) and car routing (handled by OSRM) OpenStreetMap data is used.
* [Navitia](https://github.com/hove-io/navitia) ⭐ 451 | 🐛 44 | 🌐 Python | 📅 2026-03-11 is the opensource engine behind the [Navitia.io](http://www.navitia.io/) live API.
...
* [The Mobility Database](https://mobilitydatabase.org/) - JSON and CSV files [on GitHub](https://github.com/MobilityData/mobility-database-catalogs) ⭐ 325 | 🐛 179 | 🌐 Python | 📅 2026-03-11 that is a repository of 2000+ mobility datasets across the world. Contains contents of OpenMobilityData/TransitFeeds.com.
...
* [CityBikes](http://api.citybik.es) - REST API for aggregated bikeshare data from around the world. Powered by [pyBikes](https://github.com/eskerda/pybikes) ⭐ 599 | 🐛 31 | 🌐 Python | 📅 2026-03-16.
* [Navitia.io](http://www.navitia.io/) - REST API for journey planning, stop schedules, isochrones and lot more on US and EU. [Navitia](https://github.com/hove-io/navitia) ⭐ 451 | 🐛 44 | 🌐 Python | 📅 2026-03-11 is the opensource engine behind the live API.
...
* [OpenTripPlanner unit tests](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test) ⭐ 2,573 | 🐛 154 | 🌐 Java | 📅 2026-03-17 - Some [GTFS datasets](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test/resources/gtfs) ⭐ 2,573 | 🐛 154 | 🌐 Java | 📅 2026-03-17 are defined for the unit tests ([GtfsTest](https://github.com/opentripplanner/OpenTripPlanner/blob/dev-2.x/src/test/java/org/opentripplanner/GtfsTest.java) ⭐ 2,573 | 🐛 154 | 🌐 Java | 📅 2026-03-17 and [mmri folder](https://github.com/opentripplanner/OpenTripPlanner/tree/dev-2.x/src/test/java/org/opentripplanner/mmri) ⭐ 2,573 | 🐛 154 | 🌐 Java | 📅 2026-03-17).
...
* [gtfs-realtime-validator unit tests](https://github.com/MobilityData/gtfs-realtime-validator/tree/master/gtfs-realtime-validator-lib/src/test/) ⭐ 55 | 🐛 128 | 🌐 Java | 📅 2026-03-12 - Some [GTFS datasets (zip files)](https://github.com/MobilityData/gtfs-realtime-validator/tree/master/gtfs-realtime-validator-lib/src/test/resources) ⭐ 55 | 🐛 128 | 🌐 Java | 📅 2026-03-12 are included and a large number of GTFS RT messages are defined [programmatically in Java](https://github.com/MobilityData/gtfs-realtime-validator/tree/master/gtfs-realtime-validator-lib/src/test/java/edu/usf/cutr/gtfsrtvalidator/lib/test/rules) ⭐ 55 | 🐛 128 | 🌐 Java | 📅 2026-03-12 via the gtfs-realtime-bindings library.
* [Transitland GTFS and GTFS Realtime unit tests](https://github.com/interline-io/transitland-lib) ⭐ 50 | 🐛 21 | 🌐 Go | 📅 2026-03-17 - For testing the [transitland-lib](https://github.com/interline-io/transitland-lib) ⭐ 50 | 🐛 21 | 🌐 Go | 📅 2026-03-17 library that handles GTFS and GTFS Realtime parsing and validation for Transitland:
  * [GTFS - "bad entities" at the single row level](https://github.com/interline-io/transitland-lib/tree/master/test/data/bad-entities) ⭐ 50 | 🐛 21 | 🌐 Go | 📅 2026-03-17
  * [GTFS - validation errors that that involve entities in one or more files](https://github.com/interline-io/transitland-lib/tree/master/test/data/validator/errors) ⭐ 50 | 🐛 21 | 🌐 Go | 📅 2026-03-17
  * [GTFS - best practices](https://github.com/interline-io/transitland-lib/tree/master/test/data/validator/best-practices) ⭐ 50 | 🐛 21 | 🌐 Go | 📅 2026-03-17
...
* [OTP-UI React Component Library](https://github.com/opentripplanner/otp-ui) ⭐ 69 | 🐛 87 | 🌐 TypeScript | 📅 2026-03-11 - React Javascript component library, which can be used to build trip planner webapps. See the [Storybook](http://www.opentripplanner.org/otp-ui) for a demo.
...
* [Transportr](https://github.com/grote/Transportr) ⭐ 1,153 | 🐛 109 | 🌐 Kotlin | 📅 2025-12-03 An Android app that uses [public-transport-enabler](https://github.com/schildbach/public-transport-enabler) ⭐ 434 | 🐛 194 | 🌐 Java | 📅 2026-03-06 in order to connect to many different transport networks worldwide.
* OneBusAway Apps - [Android](https://play.google.com/store/apps/details?id=com.joulespersecond.seattlebusbot) [*(source code)*](https://github.com/OneBusAway/onebusaway-android) ⭐ 538 | 🐛 176 | 🌐 Java | 📅 2026-03-15, [Fire Phone](http://www.amazon.com/gp/mas/dl/android?p=com.joulespersecond.seattlebusbot) [*(source code)*](https://github.com/OneBusAway/onebusaway-android) ⭐ 538 | 🐛 176 | 🌐 Java | 📅 2026-03-15, [iOS](https://itunes.apple.com/us/app/onebusaway/id329380089)  [*(source code)*](https://github.com/OneBusAway/onebusaway-ios) ⭐ 141 | 🐛 94 | 🌐 Swift | 📅 2026-03-15, [Windows Phone](https://www.microsoft.com/en-us/store/apps/onebusaway/9nblggh0cbd9) [*(source code)*](https://github.com/OneBusAway/onebusaway-windows-phone) ⚠️ Archived, [Google Glass GDK](https://github.com/OneBusAway/onebusaway-android/pull/219) ⭐ 538 | 🐛 176 | 🌐 Java | 📅 2026-03-15 [*(source code)*](https://github.com/OneBusAway/onebusaway-android/pull/219) ⭐ 538 | 🐛 176 | 🌐 Java | 📅 2026-03-15, [Alexa skill](https://www.amazon.com/OneBusAway/dp/B01ELVUYCW/) [*(source code)*](https://github.com/OneBusAway/onebusaway-alexa) ⭐ 52 | 🐛 17 | 🌐 Java | 📅 2022-12-16
...
* [Trufi App](https://github.com/trufi-association/trufi-app) ⭐ 13 | 🐛 2 | 🌐 Dart | 📅 2026-03-14 - A cross-platform Flutter app that uses [OpenTripPlanner](http://www.opentripplanner.org/)
...
* [TripKit](https://github.com/alexander-albers/tripkit) ⭐ 109 | 🐛 10 | 🌐 Swift | 📅 2026-02-24 - TripKit is a Swift-library to get data from public transport providers.
...
* [loom](https://github.com/ad-freiburg/loom) ⭐ 252 | 🐛 13 | 🌐 C++ | 📅 2026-02-08 - Software suite for the automated generation of geographically correct or schematic transit maps.
...
* [OpenTripPlanner](https://github.com/opentripplanner/OpenTripPlanner) ⭐ 2,573 | 🐛 154 | 🌐 Java | 📅 2026-03-17 Community
