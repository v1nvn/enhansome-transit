# awesome-transit [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 466,102 | 🐛 75 | 📅 2026-05-05 [![RSS](https://img.shields.io/badge/Subscribe-RSS-blue.svg)](https://github.com/MobilityData/awesome-transit/commits/master.atom) ⭐ 1,748 | 🐛 17 | 📅 2026-05-12
...
Have something to add or change? Open a [pull request](https://github.com/MobilityData/awesome-transit/pulls) ⭐ 1,748 | 🐛 17 | 📅 2026-05-12 or [issue](https://github.com/MobilityData/awesome-transit/issues) ⭐ 1,748 | 🐛 17 | 📅 2026-05-12 at [MobilityData/awesome-transit](https://github.com/MobilityData/awesome-transit) ⭐ 1,748 | 🐛 17 | 📅 2026-05-12.
...
* [GTFS-books](https://github.com/MobilityData/GTFS-books) ⭐ 22 | 🐛 1 | 📅 2023-05-29 - Comprehensive guides to GTFS and GTFS Realtime. These books were written by [Quentin Zervaas](https://github.com/HendX), and have been donated to [MobilityData](https://mobilitydata.org/) and made open access.
...
* [OneBusAway GTFS Modules](https://github.com/OneBusAway/onebusaway-gtfs-modules/wiki) ⭐ 144 | 🐛 31 | 🌐 Java | 📅 2026-05-11 - A Java-based library for reading, writing, and transforming public transit data in the GTFS format, including database support.
...
* [tidytransit](https://github.com/r-transit/tidytransit) ⭐ 169 | 🐛 4 | 🌐 R | 📅 2026-04-16 - Use tidytransit to map transit stops and routes, calculate travel times and transit frequencies, and validate transit feeds. tidytransit reads the General Transit Feed Specification into tidyverse and simple features data frames.
...
* [osm2gtfs](https://github.com/grote/osm2gtfs) ⭐ 102 | 🐛 32 | 🌐 Python | 📅 2024-04-04 - Turn OpenStreetMap data and schedule information into GTFS.
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 67 | 🐛 12 | 🌐 Rust | 📅 2026-05-11 - A Rust library to convert to/from the following formats: GTFS, NTFS (for Navitia, see [Software for Creating APIs](#software-for-creating-apis)), TransXChange (UK specification), KV1 (NL specification), NeTEx (EU specification).
...
* [NeTEx-to-GTFS Converter Java](https://github.com/entur/netex-gtfs-converter-java) ⭐ 9 | 🐛 8 | 🌐 Java | 📅 2026-05-12 - Converts NeTEX datasets into GTFS datasets. The input NeTEx datasets are required to follow the Nordic NeTEx Profile.
...
* [onebusaway-gtfs-to-barefoot](https://github.com/OneBusAway/onebusaway-gtfs-to-barefoot) ⭐ 1 | 🐛 1 | 🌐 Java | 📅 2020-02-11 - A Java tool to create a [Barefoot](https://github.com/bmwcarit/barefoot) ⭐ 694 | 🐛 58 | 🌐 Java | 📅 2023-04-14 mapfile from a GTFS file.
...
* [Data-Tools Server](https://github.com/ibi-group/datatools-server) ⭐ 55 | 🐛 46 | 🌐 Java | 📅 2026-05-13 - Server for IBI's GTFS data management platform.
...
* [bus-router](https://github.com/atlregional/bus-router) ⭐ 40 | 🐛 3 | 🌐 Python | 📅 2016-12-20 - Python script that generates missing shapes.txt for GTFS using routing from [Google Maps Directions API](https://developers.google.com/maps/documentation/directions/) or [OSRM](https://github.com/Project-OSRM/osrm-backend/wiki/Server-api) ⭐ 7,705 | 🐛 380 | 🌐 C++ | 📅 2026-05-13.
...
* [gtfs-blocks-to-transfers](https://github.com/TransitApp/GTFS-blocks-to-transfers) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-04-02 - A Python tool to convert GTFS blocks, defined by setting [trip.block\_id](https://github.com/google/transit/blob/master/gtfs/spec/en/reference.md#example-blocks-and-service-day) ⭐ 958 | 🐛 143 | 📅 2026-05-12 into a series of [trip-to-trip transfers (proposal)](https://github.com/google/transit/pull/303) ⭐ 958 | 🐛 143 | 📅 2026-05-12.
...
* [Uttu](https://github.com/entur/uttu) ⭐ 7 | 🐛 20 | 🌐 Java | 📅 2026-05-11 - Back-end for Nplan, a simple timetable editor.
...
* [City2Graph](https://github.com/c2g-dev/city2graph) ⭐ 1,196 | 🐛 8 | 🌐 Python | 📅 2026-05-03 - A Python library for converting GTFS data into graph representations for network analysis and Graph Neural Networks (GNNs). Supports loading GTFS feeds, constructing transit graphs, network centrality analysis, and isochrone-based accessibility analysis on multimodal (street + transit) networks. [See resource](https://city2graph.net/latest/examples/gtfs.html)
* [R5: Rapid Realistic Routing on Real-world and Reimagined networks](https://github.com/conveyal/r5) ⭐ 385 | 🐛 237 | 🌐 Java | 📅 2026-05-12 - A Java-based routing engine developed by Conveyal for multimodal (transit/bike/walk/car) networks. It currently plans many trips over a time window for scenario planning and analytics purposes. A related R wrapper package ([r5r](https://github.com/ipeaGIT/r5r/) ⭐ 234 | 🐛 36 | 🌐 R | 📅 2026-05-13) is developed independently by IPEA. See also the performance comparison from Higgins et al. (2022), linked below.
...
* [tidytransit](https://github.com/r-transit/tidytransit) ⭐ 169 | 🐛 4 | 🌐 R | 📅 2026-04-16 - An R package to read GTFS data into tibbles and simple features dataframes to map transit stops and routes, calculate travel times and transit frequencies, and validate transit feeds.
...
* [MobilityData's gtfs-validator](https://github.com/MobilityData/gtfs-validator) ⭐ 404 | 🐛 147 | 🌐 Java | 📅 2026-05-13 - A open-source GTFS validator canonically following the GTFS spec implemented in Java licensed under Apache v2.0 maintained by [MobilityData](https://mobilitydata.org/).
...
* [gtfs-validator-api](https://github.com/cal-itp/gtfs-validator-api) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2023-08-16 - This Python package is a thin wrapper around [MobilityData/gtfs-validator](https://github.com/MobilityData/gtfs-validator) ⭐ 404 | 🐛 147 | 🌐 Java | 📅 2026-05-13 that handles intermediate files produced and finds gtfs-validator's output file so it can be given a specific name or returned as a string.
...
* [gtfs-validator-metrics-service](https://github.com/mobidata-bw/gtfs-validator-metrics-service) ⭐ 1 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-13 - Validates GTFS Schedule datasets using MobilityData's GTFS-Validator and exposes the results as Prometheus/OpenTelemetry metrics.

### GTFS Realtime

* [GTFS-realtime documentation](https://github.com/google/transit/tree/master/gtfs-realtime) ⭐ 958 | 🐛 143 | 📅 2026-05-12.
* [GTFS-realtime Autodoc](https://laidig.github.io/gtfs-rt-autodoc/index.html) - Automatically generated documentation for GTFS-realtime, generated from the official [GTFS-realtime protocol buffer specification](https://github.com/google/transit/blob/master/gtfs-realtime/proto/gtfs-realtime.proto) ⭐ 958 | 🐛 143 | 📅 2026-05-12 and including some extensions.

#### GTFS Realtime Libraries & Demo Apps

* [gtfs-realtime-bindings](https://github.com/google/gtfs-realtime-bindings) ⭐ 426 | 🐛 41 | 🌐 JavaScript | 📅 2026-05-13 - The official bindings for Java, .NET, Node.js, Python, and Ruby generated from the official [GTFS-realtime protocol buffer specification](https://github.com/google/transit/blob/master/gtfs-realtime/proto/gtfs-realtime.proto) ⭐ 958 | 🐛 143 | 📅 2026-05-12.
...
* [Concentrate](https://github.com/mbta/concentrate) ⭐ 30 | 🐛 13 | 🌐 Elixir | 📅 2026-05-12 - Combines realtime transit information from multiple sources into single output files. Maintained by [
...
* [TIDES](https://github.com/TIDES-transit/TIDES) ⭐ 55 | 🐛 50 | 🌐 Python | 📅 2026-05-11 -  Transit ITS Data Exchange Specification (TIDES) is a proposed effort to create standard data structures, APIs, and data management tools for historical transit ITS data including AVL, APC and AFC Data.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper/#public-transit) ⭐ 6,446 | 🐛 245 | 🌐 Java | 📅 2026-05-12 Open source routing engine for OpenStreetMap. Use it as Java library or server.
* [pyBikes](https://github.com/eskerda/pybikes) ⭐ 603 | 🐛 32 | 🌐 Python | 📅 2026-05-13 - Software powering [CityBikes](http://api.citybik.es) for worldwide bikeshare system info
* [Navitia](https://github.com/hove-io/navitia) ⭐ 454 | 🐛 48 | 🌐 Python | 📅 2026-05-13 is the opensource engine behind the [Navitia.io](http://www.navitia.io/) live API.
...
* [The Mobility Database](https://mobilitydatabase.org/) - JSON and CSV files [on GitHub](https://github.com/MobilityData/mobility-database-catalogs) ⭐ 329 | 🐛 233 | 🌐 Python | 📅 2026-05-13 that is a repository of 2000+ mobility datasets across the world. Contains contents of OpenMobilityData/TransitFeeds.com.
...
* [CityBikes](http://api.citybik.es) - REST API for aggregated bikeshare data from around the world. Powered by [pyBikes](https://github.com/eskerda/pybikes) ⭐ 603 | 🐛 32 | 🌐 Python | 📅 2026-05-13.
* [Navitia.io](http://www.navitia.io/) - REST API for journey planning, stop schedules, isochrones and lot more on US and EU. [Navitia](https://github.com/hove-io/navitia) ⭐ 454 | 🐛 48 | 🌐 Python | 📅 2026-05-13 is the opensource engine behind the live API.
...
* [Transitland GTFS and GTFS Realtime unit tests](https://github.com/interline-io/transitland-lib) ⭐ 51 | 🐛 18 | 🌐 Go | 📅 2026-05-14 - For testing the [transitland-lib](https://github.com/interline-io/transitland-lib) ⭐ 51 | 🐛 18 | 🌐 Go | 📅 2026-05-14 library that handles GTFS and GTFS Realtime parsing and validation for Transitland:
...
* [Home Assistant](https://github.com/home-assistant/core/tree/dev/homeassistant/components/gtfs) ⭐ 87,048 | 🐛 3,928 | 🌐 Python | 📅 2026-05-14 The General Transit Feed Specification (GTFS) integration was introduced in Home Assistant 0.17, and it's used by 70 active installations.
* [Transportr](https://github.com/grote/Transportr) ⭐ 1,168 | 🐛 112 | 🌐 Kotlin | 📅 2026-03-24 An Android app that uses [public-transport-enabler](https://github.com/schildbach/public-transport-enabler) ⭐ 438 | 🐛 207 | 🌐 Java | 📅 2026-04-18 in order to connect to many different transport networks worldwide.
...
* [Train departure Display](https://github.com/chrisys/train-departure-display) ⭐ 315 | 🐛 30 | 🌐 Python | 📅 2026-04-21 - A replica, near real-time, miniature UK railway station train departure sign based upon a Raspberry Pi Zer0.
...
* [motis-fptf-client](https://www.npmjs.com/package/@motis-project/motis-fptf-client) - A [Friendly Public Transport Format (FPTF)](https://github.com/public-transport/friendly-public-transport-format) ⭐ 139 | 🐛 22 | 📅 2026-02-23 client for [MOTIS](https://github.com/motis-project/motis) ⭐ 506 | 🐛 99 | 🌐 C++ | 📅 2026-05-14 that is a drop-in replacement for [hafas-client](https://github.com/public-transport/hafas-client/) ⭐ 348 | 🐛 60 | 🌐 JavaScript | 📅 2026-01-09 and/or [db-vendo-client](https://github.com/public-transport/db-vendo-client/) ⭐ 192 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-26.
...
* [Toronto Transit Explorer](https://github.com/sidewalklabs/totx) ⚠️ Archived - A Java application that visualizes transit, biking and walking accessibility across the city of Toronto. Uses a modified version of [R5](https://github.com/conveyal/r5) ⭐ 385 | 🐛 237 | 🌐 Java | 📅 2026-05-12 for routing.
...
* [OpenTripPlanner](https://github.com/opentripplanner/OpenTripPlanner) ⭐ 2,634 | 🐛 150 | 🌐 Java | 📅 2026-05-13 Community
